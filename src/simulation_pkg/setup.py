...
def package_tree(source_directory):
    """Install a model directory recursively without duplicating source data."""
    entries = []
...
setup(
    ...
    entry_points={
        ...
        'load_towing_system_node = simulation_pkg.lib.load_towing_system_node:main',
